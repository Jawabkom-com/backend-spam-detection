...
interface ISpamPhoneScoreRepository
{
    ...
    public function getByPhoneAndSource($phone, $source): ?ISpamPhoneScoreEntity;
    public function updateEntity(ISpamPhoneScoreEntity $entity, array $params):ISpamPhoneScoreEntity;
}
